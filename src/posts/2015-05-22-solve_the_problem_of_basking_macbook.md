...
categories: blog
tags: >
  MacBook, утилиты, macbook греется pro air сильно retina 13" 15" почему
description: >
...
{% include "media-image.liquid", url: "mac/smcFanControl.png", width: "337", height: "458", caption: "Интерфейс настроек smcFanControl для Mac OS" %}
