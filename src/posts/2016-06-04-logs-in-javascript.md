...
{% include "media-image.html", url: "logs/googlemap.png", width: "420", height: "140", caption: "Логи модуля GoogleMaps" %}
...
{% include "media-youtube.html", url: "nPYmp586EE0", width: "560", height: "315", caption: "Антон Шувалов — «Отладка кода в браузере»" %}
