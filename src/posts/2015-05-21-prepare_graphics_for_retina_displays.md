...
{% include "media-image.liquid", url: "retina/retinizeit.png", width: "520", height: "340", caption: "Retinize It — плагин для фотошопа для оптимизации графики под ретина" %}
...
{% include "media-image.liquid", url: "retina/install.png", width: "940", height: "220", caption: "Как работает плагин Retinize It" %}
