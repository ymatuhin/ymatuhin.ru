...
В примерах использовалась библиотека jQuery, но также можно загружать и другие библиотеки.
...
1. [Cdnjs](https://cdnjs.com/) — тут есть наверное все js библиотеки, поскольку их можно захостить туда
   любому желающему;
1. [jsDelivr](http://www.jsdelivr.com/) — также куча библиотек, можно заливать свои;
