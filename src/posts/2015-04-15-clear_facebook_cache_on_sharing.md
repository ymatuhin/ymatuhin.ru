...
{% include "media-image.html", url: "facebook_sharing_error/facebook_debugger.png", width: "947", height: "353", caption: "Debugger — окно для очистки КЭШа в Facebook" %}
...
{% include "media-image.html", url: "facebook_sharing_error/facebook_debugger_refetch.png", width: "936", height: "200", caption: "Debugger — окно для очистки КЭШа в Facebook" %}
...
{% include "media-image.html", url: "facebook_sharing_error/vk_sharing.png", width: "500", height: "380", caption: "Форма очиститки кэша при шаринге Вконтакте" %}
