...
{% include "media-image.liquid", url: "vivaldi/default_view_inactive.png", caption: "Vivaldi – вид по умолчанию без фокуса", width: "1364", height: "857" %}
...
{% include "media-image.liquid", url: "vivaldi/fast_commands.png", caption: "Vivaldi – быстрые команды", width: "563", height: "396" %}
...
{% include "media-image.liquid", url: "vivaldi/tabs_top.png", caption: "Vivaldi – раскрытые табы сверху", width: "476", height: "367", alt: "Раскрытые табы сверху в браузере Vivaldi" %} %}

{% include "media-image.liquid", url: "vivaldi/tabs_left.png", caption: "Vivaldi – раскрытые табы слева", width: "256", height: "399", alt: "Раскрытые табы слева в браузере Vivaldi" %} %}

{% include "media-image.liquid", url: "vivaldi/settings.png", caption: "Vivaldi – Окно настроек", width: "852", height: "672" %}

## Цвет панели табов меняется в зависимости от сайта

{% include "media-image.liquid", url: "vivaldi/tabs_colorful.png", caption: "Vivaldi – изменение цвета панели табов в зависимости от открытого сайта", width: "750", height: "270", alt: "Цвета панели табов в браузере Vivaldi" %} %}
...
{% include "media-image.liquid", url: "vivaldi/speed_dial.png", caption: "Vivaldi – Speed Dial", alt: "Speed Dial в браузере Vivaldi", width: "1364", height: "885" %}
...
{% include "media-image.liquid", url: "vivaldi/left_panel.png", caption: "Vivaldi – боковая панель", width: "152", height: "337", alt: "Боковая панель в браузере Vivaldi" %} %}
...
{% include "media-image.liquid", url: "vivaldi/download_1.png", caption: "Vivaldi – окно загрузки #1", width: "457", height: "212", alt: "Vivaldi – окно загрузки #1" %} %}

{% include "media-image.liquid", url: "vivaldi/download_2.png", caption: "Vivaldi – окно загрузки #2", alt: "Vivaldi – окно загрузки #2", width: "536", height: "304" %}

{% include "media-image.liquid", url: "vivaldi/download_3.png", caption: "Vivaldi – окно загрузки #3", width: "283", height: "289", alt: "Vivaldi – окно загрузки #3" %} %}

## Заметки прямо в браузере

{% include "media-image.liquid", url: "vivaldi/notes.png", caption: "Vivaldi – заметки в браузере", width: "286", height: "706", alt: "Заметки в браузере Vivaldi" %} %}

Так же есть возможность добавить ссылку к заметке и сгенерировать превью.

##  Page actions, или действия со страницей

{% include "media-image.liquid", url: "vivaldi/page_actions.png", caption: "Vivaldi – page actions", width: "260", height: "532", alt: "Page actions в браузере Vivaldi" %} %}
...
{% include "media-image.liquid", url: "vivaldi/page_actions_hover.png", caption: "Vivaldi – page actions hover", alt: "Page actions hover в браузере Vivaldi", width: "1392", height: "885" %}

{% include "media-image.liquid", url: "vivaldi/page_actions_outline.png", caption: "Vivaldi – page actions hover", alt: "Page actions hover в браузере Vivaldi", width: "1392", height: "885" %}
