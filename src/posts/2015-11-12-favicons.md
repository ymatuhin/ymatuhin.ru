...
{% include "media-image.html", url: "favicon/real_favicon_generator.png", caption: "Real Favicon Generator Logo", width: "507", height: "188" %}
...
{% include "media-image.html", url: "favicon/safari_9.png", alt: "Иконка закрепленной вкладки в Safari сайта ymatuhin.ru", width: "504", height: "376" %}
{% include "media-image.html", url: "favicon/favicon_preview.png", alt: "iOS, Android, Windows 8 фавиконка сайта ymatuhin.ru", width: "977", height: "200" %}
{% include "media-image.html", url: "favicon/iphone.png", alt: "iPhone фавиконка сайта ymatuhin.ru", width: "640", height: "1136" %}
