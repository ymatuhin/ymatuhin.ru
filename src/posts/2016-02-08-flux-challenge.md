...
{% include "media-image.liquid", url: "test-framework/sith-database.gif", caption: "Flux Challenge — база данных ситхов" link="https://github.com/staltz/flux-challenge", width: "684", height: "406" %}
...
{% include "media-image.liquid", url: "test-framework/friendlist.gif", caption: "Friend List", link: "https://github.com/DerekCuevas/friend-list", width: "565", height: "531" %}
