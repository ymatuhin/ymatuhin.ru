...
{% include "media-image.liquid", url: "find_the_best_dns/programm.png", width: "599", height: "393", caption: "Namebench — программа для поиска быстрого DNS сервера" %}
...
{% include "media-image.liquid", url: "find_the_best_dns/rezults.png", width: "1029", height: "605", caption: "Результаты поиска" %}
...
{% include "media-image.liquid", url: "find_the_best_dns/rezults2.jpg", width: "747", height: "442", caption: "Результаты поиска #2" %}
