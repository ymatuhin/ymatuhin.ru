...
{% include "media-image.liquid", url: "yota/yota_sharing.png", width: "675", height: "626", caption: "Ограничение на раздачу интернета — Yota" %}
...
{% include "media-image.liquid", url: "yota/regedit.png", width: "400", height: "241", caption: "Командная строка в Windows — yota без ограничения скорости" %}
