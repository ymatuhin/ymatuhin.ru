...
сверхдлинная ошибка возникла из-за белой обезъяны. Не говори про обезъяну! Не слушай об обезьяне! Не думай об обезъяне!<
span
class="pds">'</span></span>;

<span class="c">// плохо</span>
<span class="k">var</span> errorMessage <span class="k">=</span> <span class="s"><span class="pds">'</span>Эта
сверхдлинная ошибка возникла из-за белой обезъяны. \</span>
