...
В процессе разработки веб сайтов и приложений, разработчик сталкивается с проблемой поддержки всех, нужных для него, браузеров. Но некоторые свойства работают только с вендорными префиксами (в некоторых браузерах). Для этого был создан проект **Autoprefixer**.
...
На всякий случай я включил в пример поддержку браузеров с долей выше 2%.

Дополнения и замечания оставляйте на [github](https://github.com/autoprefixer/autoprefixer.github.io).

Актуальные префиксы вам подскажет [Autoprefixer online](https://autoprefixer.github.io).
